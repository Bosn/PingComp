export const zh = {
  ...
  enrichConceptAlert: '该区域仍为概念设计，功能尚未完工。',
  bulkAction: '批量动作', apply: '执行', selected: '已选', quickViews: '快捷视图', savedViews: '已保存视图', saveView: '保存当前视图', deleteView: '删除视图', viewName: '视图名', account: '账户', logout: '退出', delete: '删除', deleteConfirm: '确认删除该线索？', deleteModalTitle: '确认删除', deleteModalDesc: '删除后不可恢复，请确认操作。', cancel: '取消', confirmDelete: '确认删除', askAgent: '问问 Agent', askPlaceholder: '例如：找出 owner 为某人、分数大于80的客户', sessions: '会话', newSession: '新建会话', deleteSession: '删除会话', sessionName: '会话名称', addLead: '添加线索', addLeadTitle: '手动添加线索', createLead: '创建线索', createLeadSuccess: '线索创建成功', createLeadFailed: '线索创建失败', saveLeadFailed: '线索保存失败', networkError: '网络异常，请稍后重试', nameVerticalRequired: 'Name 和 Vertical 必填',
} as const;
